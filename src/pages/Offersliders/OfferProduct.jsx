...
function OfferProducts() {
  ...
  return (
    <>
      {/* ================= SEO ================= */}
      <Helmet>
        <title>{offer.title} | Stuvely Offers</title>
        <meta
          name="description"
          content={
            offer.subtitle
              ? offer.subtitle
              : `Get the best deals and up to ${offer.offerPercent}% off on ${offer.title} at Stuvely.`
          }
        />
        <meta
          name="keywords"
          content={`${offer.title}, ${offer.title} offer, ${offer.offerPercent}% off, Stuvely deals`}
        />
        <link rel="canonical" href={`https://stuvely.com/offers/${offer.slug}`} />
      </Helmet>
